...
const CHAMPIONS_2024_FINAL = "https://www.vlr.gg/378829/edward-gaming-vs-team-heretics-valorant-champions-2024-gf";

export const PRO_PICKS: ProPick[] = [
  {
    id: "champions-2024-edg-haven-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Haven",
    region: "China",
    team: "Edward Gaming",
    agents: ["Neon", "Cypher", "Breach", "Omen", "Sova"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-th-haven-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Haven",
    region: "EMEA",
    team: "Team Heretics",
    agents: ["Sova", "Neon", "Cypher", "Breach", "Omen"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-edg-sunset-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Sunset",
    region: "China",
    team: "Edward Gaming",
    agents: ["Neon", "Omen", "Cypher", "KAY/O", "Sova"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-th-sunset-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Sunset",
    region: "EMEA",
    team: "Team Heretics",
    agents: ["KAY/O", "Omen", "Sova", "Raze", "Cypher"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-edg-lotus-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Lotus",
    region: "China",
    team: "Edward Gaming",
    agents: ["Omen", "Neon", "Fade", "Clove", "Breach"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-th-lotus-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Lotus",
    region: "EMEA",
    team: "Team Heretics",
    agents: ["Omen", "Killjoy", "Viper", "Raze", "Fade"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-edg-bind-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Bind",
    region: "China",
    team: "Edward Gaming",
    agents: ["Raze", "Viper", "Fade", "Brimstone", "Gekko"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-th-bind-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Bind",
    region: "EMEA",
    team: "Team Heretics",
    agents: ["Raze", "Brimstone", "Gekko", "Fade", "Viper"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-edg-abyss-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Abyss",
    region: "China",
    team: "Edward Gaming",
    agents: ["Omen", "Jett", "KAY/O", "Sova", "Astra"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
    id: "champions-2024-th-abyss-gf",
    event: "VALORANT Champions 2024",
    match: "Edward Gaming vs Team Heretics",
    map: "Abyss",
    region: "EMEA",
    team: "Team Heretics",
    agents: ["Cypher", "Gekko", "Sova", "Jett", "Astra"],
    source: CHAMPIONS_2024_FINAL,
  },
  {
