...
const COPY = {
  ja: {
    ...
    chatTitle: "AI相談",
    chatBody: "入力された相談内容と直近の会話は、回答生成のためCloudflare Workers AIへ送信されます。無関係と判定された入力はAIへ送信しません。現段階ではチャット本文をD1へ永続保存しません。API障害調査のため、Cloudflareの実行ログへエラー情報が短期間記録される場合があります。秘密情報や個人情報は入力しないでください。",
    statsTitle: "試合統計",
  ...
  en: {
    ...
    chatTitle: "AI advice",
    chatBody: "Your question and recent conversation context are sent to Cloudflare Workers AI to generate a response. Inputs rejected as unrelated are not sent to AI. Chat text is not currently persisted in D1. Error details may appear temporarily in Cloudflare execution logs for troubleshooting. Do not enter secrets or personal information.",
  ...
  ko: {
    ...
    chatTitle: "AI 상담",
    chatBody: "질문과 최근 대화 문맥은 답변 생성을 위해 Cloudflare Workers AI로 전송됩니다. 관련 없는 입력은 AI로 전송하지 않습니다. 현재 채팅 본문은 D1에 영구 저장하지 않습니다. 장애 조사용 오류 정보가 Cloudflare 실행 로그에 일시적으로 남을 수 있습니다. 비밀 정보나 개인정보를 입력하지 마세요.",
    statsTitle: "경기 통계",
